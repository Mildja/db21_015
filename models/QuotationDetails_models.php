<?php
    ...
    public static function search($key)
    {
        ...
        WHERE (PL_ID LIKE '%$key%' OR Q_ID LIKE '%$key%' OR P_ID LIKE '%$key%' OR Product_list.Color_ID LIKE '%$key%'OR Product_list.NumOfProduct LIKE '%$key%' OR NumColorScreen LIKE '%$key%' OR P_name LIKE '%$key%' OR Product.C_name LIKE '%$key%' OR Product.P_manage LIKE '%$key%' OR Product_list.Color_ID LIKE '%$key%'OR Product_list.NumOfProduct LIKE '%$key%' OR Color.Color_name LIKE '%$key%' OR Quotation.Emp_ID LIKE '%$key%')";
